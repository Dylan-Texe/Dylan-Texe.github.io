...
Personal site for Dylan ([@Dylan_Texe](https://x.com/Dylan_Texe)).

GitHub Pages portfolio of work: [dylan-texe.github.io](https://dylan-texe.github.io/).
...
- [Tech Briefing](https://thetechbriefing.com) — live. Private intelligence. Morning desk briefing. The product is at thetechbriefing.com.
...
No build step. The site is static HTML and CSS.
